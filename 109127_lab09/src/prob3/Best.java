...
public class Best {
	public static final MyFunctionInterface<List<String>, CharSequence, CharSequence, Integer>
				containsLetter = (list, first, second, len) -> (int) list.stream()
					.filter(name -> name.contains(first) && !name.contains(second) && name.length() == len)
					.count();
